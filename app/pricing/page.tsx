...
const plans = {
  ...
  zh: [
    ...
    },
    {
      ...
      features: ["每月不限量AI情书", "高级情感分析", "10种写作风格", "数字信件收藏", "情感色温调节", "记忆存档系统"],
      cta: "立即开始",
      popular: true,
    },
    {
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 pt-32">
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className={`text-3xl text-gray-900 ${language === "en" ? "font-serif" : "font-serif-zh"}`}>
                      ¥
                    </span>
                    <span className={`text-4xl text-gray-900 ${language === "en" ? "font-serif" : "font-serif-zh"}`}>
                      {plan.price}
                    </span>
                  ...
                  <ul className="space-y-3">
                    {plan.features.map((feature) => (
                      <li key={feature} className="flex items-start gap-3 text-sm">
                        ...
                        <span className={`text-gray-600 ${language === "en" ? "font-serif" : "font-serif-zh"}`}>
                          {feature}
                        </span>
                      </li>
                    ))}
          ...
          <div className="mt-16 text-center">
            <p className={`text-sm text-gray-500 ${language === "en" ? "font-serif" : "font-serif-zh"}`}>
              ...
              <Link href="/contact" className="text-[#738fbd] hover:text-[#cc8eb1] transition-colors ml-1">
