      ...
      <main className="flex-grow relative z-10 pt-20">
        <article className="container mx-auto px-4 py-12 max-w-3xl">
          <header className="mb-16 text-center">
            <motion.div
              className="mb-2 text-sm tracking-wider text-gray-600 uppercase"
          ...
          <div className="prose prose-lg md:prose-xl max-w-none">
            {content[language].paragraphs.map((paragraph, index) => (
              <motion.p
                key={index}
                className={cn(
                  'mb-8 leading-loose text-gray-700',
          ...
          >
            <div className="text-right space-y-2">
              ...
              <p
                className={cn(
                  'text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#738fbd] to-[#cc8eb1]',
                  language === 'en' ? 'font-serif' : 'font-serif-zh'
                )}
              >
                {content[language].author}
