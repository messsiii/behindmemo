    ...
    sections: [
      {
        ...
        content:
          "Behind Memory ('we', 'our', or 'us') is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.",
      },
      {
      ...
      },
      {
        title: '10. Contact Us',
        content:
          'If you have any questions about this Privacy Policy, please contact us at: sean@behindmemory.com',
      },
    ],
  },
  zh: {
    ...
    sections: [
      {
        title: '1. 简介',
        content:
          'Behind Memory（以下简称"我们"）致力于保护您的隐私。本隐私政策说明了我们在您使用我们的网站和服务时如何收集、使用、披露和保护您的信息。请仔细阅读本隐私政策。如果您不同意本隐私政策的条款，请不要访问本网站。',
      },
      {
        title: '2. 我们收集的信息',
        content:
          '我们收集您直接提供给我们的信息，例如当您创建账户、使用我们的服务或联系我们寻求支持时。这可能包括您的姓名、电子邮件地址和您创建的信件内容。我们还会自动收集您使用我们网站时的某些信息，包括您的IP地址、浏览器类型和使用数据。',
      },
      {
        title: '3. 我们如何使用您的信息',
        content:
          '我们使用收集的信息来提供、维护和改进我们的服务，与您沟通，并遵守法律义务。这包括使用您的信息基于您的输入生成AI辅助的记忆。我们不会将您的个人信息用于自动决策或分析。',
      },
      {
        title: '4. 数据存储和安全',
        content:
          '我们实施各种安全措施来维护您个人信息的安全。您的个人信息存储在安全网络之后，只有少数拥有特殊访问权限的人员才能访问这些系统，并且需要对信息保密。',
      },
      {
        title: '5. 您的数据保护权利',
        content:
          '根据《通用数据保护条例》(GDPR)，您有权访问、更正或删除您的个人数据，以及限制或反对我们处理您的数据的权利。您还有数据可携带性的权利。要行使这些权利，请使用本政策末尾提供的信息与我们联系。',
      },
      {
        title: '6. 第三方披露',
        content:
          '我们不会出售、交易或以其他方式将您的个人身份信息转让给外部各方。这不包括协助我们运营网站、开展业务或为您提供服务的可信第三方，只要这些方同意对这些信息保密。',
      },
      {
        title: '7. Cookie和跟踪技术',
        content:
          '我们使用cookie和类似的跟踪技术来跟踪我们服务上的活动并保存某些信息。您可以指示您的浏览器拒绝所有cookie或在发送cookie时发出提示。',
      },
      {
        title: '8. 儿童隐私',
        content:
          '我们的服务不面向13岁以下的任何人。我们不会故意收集13岁以下儿童的个人身份信息。如果您是父母或监护人，并且您知道您的孩子向我们提供了个人数据，请联系我们。',
      },
      {
        title: '9. 本隐私政策的变更',
        content:
          '我们可能会不时更新我们的隐私政策。我们会通过在此页面上发布新的隐私政策并更新隐私政策顶部的"最后更新"日期来通知您任何更改。',
      },
      {
        title: '10. 联系我们',
